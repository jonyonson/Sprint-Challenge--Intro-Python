...
# Hint: normalize the input data so that it's always one or the other, then
# search for cities. In the example below, inputting 32, -120 first and then
...
def cityreader_stretch(lat1, lon1, lat2, lon2, cities=[]):
    ...
    for city in cities:
        if (city.lat < max_lat and city.lat > min_lat and
                city.lon < max_lon and city.lon > min_lon):
            within.append(city)
